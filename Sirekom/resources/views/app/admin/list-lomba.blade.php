...
<style>
    ...
    border-radius: 10px; width: 362px; height: 48px;
    display: flex;
                    ...
                    <div class="card rounded-4 border-0" style="width: 20rem;">
                        <div class="action">
                            ...
                            <form action="{{ route('lomba.destroy', $lomba->id) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="action-btn red" onclick="return confirm('Are you sure you want to delete this item?')">
...
<div class="container">
    ...
    <div class="row mb-3 d-flex justify-content-center">
        <div class="col-4 d-flex justify-content-center align-items-center mb-3">
            <a href="/admin/lomba/create" class="bgc">Tambah Data</a>
        </div>
    </div>
    @if (session('success'))
        <div class="alert alert-success my-3">
